...
class Generator(nn.Module):
    ...
    def __init__(self,
        ...
        self.lstm: nn.LSTM = nn.LSTM(input_size=lstm_input_dim, hidden_size=lstm_hidden_state_dim, batch_first=True)
        ...
        for _ in range(self.num_fc_layers):
            fc_layers.append(nn.Linear(in_features=input_dim, out_features=hidden_fc_dim))
...
class Discriminator(nn.Module):
    ...
    def __init__(self,
        ...
        self.last_fc_layer = nn.Linear(in_features=self.fc_out_dim, out_features=1)
